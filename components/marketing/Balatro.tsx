...
export default function Balatro({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      // ogl sets inline px size — force % so the canvas never expands page scroll.
      lockCanvasCss();
      if (program) {
    ...
    // Window listener so mouse still works behind interactive page content.
